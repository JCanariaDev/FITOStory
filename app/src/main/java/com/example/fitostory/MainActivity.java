...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initializeClass.setUpStory();*/

        setUpTwoChoices = new SetUpTwoChoices(dataBaseHelper);
        setUpTwoChoices.setUpStory();

        stories = dataBaseHelper.getAllStory();

        storyRecyclerView = findViewById(R.id.recyclerView);
        storyAdapter = new QuickFeatureAdapter(getApplicationContext(), stories, R.layout.quick_features_cardview);
        ...
        //Implement the arrow button
        ImageView imageView2 = findViewById(R.id.imageView2);
        ImageView backArrow = findViewById(R.id.backArrow);
        backArrow.setVisibility(View.INVISIBLE); // Initially hide back button

        LinearLayoutManager layoutManager = (LinearLayoutManager) storyRecyclerView.getLayoutManager();
        ...
        imageView2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int nextPosition = currentPosition + 1; // Move to next item

                if (nextPosition < storyAdapter.getItemCount()) {
                    storyRecyclerView.smoothScrollToPosition(nextPosition);
                    backArrow.setVisibility(View.VISIBLE); // Show back button when moving forward
                }
            }
        });
        ...
        backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int currentPosition = layoutManager.findFirstVisibleItemPosition();
                int previousPosition = currentPosition - 1; // Move to previous item

                if (previousPosition >= 0) {
                    storyRecyclerView.smoothScrollToPosition(previousPosition);
                }

                // Hide back button if we're at the first item
                if (previousPosition == 0) {
        ...
        storyRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                // Hide backArrow if at the first item
    ...
    public void btnClick(View view) {
        ...
        } else if (view.getId() == R.id.storiesBtn){
            Intent i = new Intent(this, AllStoryActivity.class);
            startActivity(i);
        } else if (view.getId() == R.id.quizBtn){
            Intent i = new Intent(this, QuizTabActivity.class);
            startActivity(i);
        } else if (view.getId() == R.id.favoritesBtn){
            Intent i = new Intent(this, FavoritesActivity.class);
            startActivity(i);
        } else if (view.getId() == R.id.homeBtn){
            //Toast.makeText(this, "Nav Home Button Clicked", Toast.LENGTH_SHORT).show();
