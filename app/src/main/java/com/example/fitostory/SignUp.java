...
public class SignUp extends AppCompatActivity {
    ...
    public void goToMainActivity(View view) {
        ...
        } else if (dataBaseHelper.isEmailExists(inputEmail)) {
            // Using AlertHelper instead of Toast
            //AlertHelper.showAnimatedAlert(this, "Email already registered", false);
            showBlobShapedAlert("Email already registered!", "", "😵", 0xFFE57373, badSound);
        } else {
            UserInfo userInfo = new UserInfo(inputEmail, inputUsername, inputPassword, R.drawable.profile);
            boolean success = dataBaseHelper.addUser(userInfo);
            if (success) {
                // Using AlertHelper instead of Toast for success message
                //AlertHelper.showAnimatedAlert(this, "Account created successfully!", true);
                showBlobShapedAlert("Account created successfully!!", "", "😊", 0xFF81C784, goodSound, inputEmail);
                ...
                // Using AlertHelper instead of Toast for error message
                //AlertHelper.showAnimatedAlert(this, "Sign up failed. Please try again.", false);
                showBlobShapedAlert("Sign up failed!", "", "😵", 0xFFE57373, badSound);
            }
        }
    }
