...
public class FavoritesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storyAdapter = new QuickFeatureAdapter(getApplicationContext(), filteredList, R.layout.favorites_item);
    ...
    private void checkIfEmpty(){
        ...
        if (filteredList.isEmpty()) {
            ...
            noDataText.setVisibility(View.VISIBLE);  // Show "No Data" message
        } else {
            recyclerView.setVisibility(View.VISIBLE);  // Show RecyclerView
            noDataText.setVisibility(View.GONE);  // Hide "No Data" message
        }
    ...
    public void setUpStories(){
        storyClasses = new ArrayList<>();
        dataBaseHelper = new DataBaseHelper(FavoritesActivity.this);

        ArrayList<String> storyNames = dataBaseHelper.getAllFavoritesName();

        for (String s: storyNames){
            ArrayList<StoryClass> stories = dataBaseHelper.getAllStory();
            for (StoryClass storyClass: stories){
                if (storyClass.getStoryTitle().equals(s)){
                    Toast.makeText(this, "Favorites found!", Toast.LENGTH_SHORT).show();
                    storyClasses.add(storyClass);
                }
            }
        }
    }
