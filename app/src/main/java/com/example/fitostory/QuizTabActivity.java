...
public class QuizTabActivity extends AppCompatActivity {
    private EditText searchEditText;
    private ImageView searchButton;
    private ArrayList<QuizClass> filteredList;

    DataBaseHelper dataBaseHelper;
    private ArrayList<QuizClass> quizClasses;
    Toolbar toolbar;

    private GestureDetector gestureDetector;

    private RecyclerView quizRecyclerView;
    private QuickFeatureAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_tab);
        ...
        dataBaseHelper = new DataBaseHelper(QuizTabActivity.this);
        quizClasses = dataBaseHelper.getAllQuizzes();
        ...
        filteredList = new ArrayList<>(quizClasses);

        quizRecyclerView = findViewById(R.id.recyclerView);
        adapter = new QuickFeatureAdapter(getApplicationContext(), filteredList, R.layout.quiz_item);
        quizRecyclerView.setAdapter(adapter);
        quizRecyclerView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));
    ...
    private void filterList(String query) {
        filteredList.clear();
        if (query.isEmpty()) {
            filteredList.addAll(quizClasses);
        } else {
            for (QuizClass quizClass : quizClasses) {
                if (quizClass.getStoryName().toLowerCase().contains(query.toLowerCase())) {
                    filteredList.add(quizClass);
                }
            }
        }
    ...
    public void btnClick(View view) {
        if (view.getId() == R.id.homeBtn){
            ...
            //Toast.makeText(this, "Nav Quiz Button Clicked", Toast.LENGTH_SHORT).show();
