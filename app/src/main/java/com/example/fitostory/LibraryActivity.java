...
public class LibraryActivity extends AppCompatActivity {
    ...
    //private CreatureAdapter adapter; // Adapter for RecyclerView
    private ArrayList<LibraryClass> filteredList;

    DataBaseHelper dataBaseHelper;
    ArrayList<LibraryClass> libraryClasses;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        libraryClasses = dataBaseHelper.getAllLibraries();
        filteredList = new ArrayList<>(libraryClasses); // Initially, show all creatures

        libraryRecyclerView = findViewById(R.id.recyclerView);
        adapter = new QuickFeatureAdapter(getApplicationContext(), filteredList, R.layout.library_item);
    ...
    private void filterList(String query) {
        filteredList.clear();
        if (query.isEmpty()) {
            filteredList.addAll(libraryClasses);
        } else {
            for (LibraryClass libraryClass : libraryClasses) {
                if (libraryClass.getLibraryCreatureName().toLowerCase().contains(query.toLowerCase())) {
                    filteredList.add(libraryClass);
                }
            }
        }
